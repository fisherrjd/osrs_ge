...
- `aggregator/db/data_input.py:25` → `"sqlite:///item_data.db"`
...
#### 3. Timezone Handling
**Location:** `aggregator/db/data_input.py`
...
**Priority:** Medium
**Recommendations:**
- Create `aggregator/config.py` for centralized config
...
**File:** `aggregator/models/item_model.py:31`
